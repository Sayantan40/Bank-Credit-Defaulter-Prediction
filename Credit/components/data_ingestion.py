...
class DataIngestion:
    ...
    def download_Credit_data(self,) -> str:
        ...
        try:
            ...
            Credit_file_name = "Credit_data.zip"
    ...
    def extract_zip_file(self,zip_file_path:str):
        ...
        try:
            ...
            with ZipFile(zip_file_path) as Credit_zip_file_obj:
                
                Credit_zip_file_obj.extractall(path = raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            input_feature_df = Credit_data_frame.drop(columns="default_payment_next_month",axis=1)
            
            target_feature_df = Credit_data_frame["default_payment_next_month"]
