...
from Credit.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
from Credit.constants import *
import numpy as np
import os
import sys
from Credit.utils.util import write_yaml_file, read_yaml_file, load_object,load_data
...
class ModelEvaluation:
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        ...
        try:
            ...
            eval_result = {BEST_MODEL_KEY: {MODEL_PATH_KEY: model_evaluation_artifact.evaluated_model_path}}
